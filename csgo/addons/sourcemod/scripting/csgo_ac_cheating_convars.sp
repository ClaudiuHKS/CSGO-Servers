...
#define CHECK_SV_SKYNAME_TOO /** Delete This Definition, If You Are Using A Sky Changer Plug-in On Your Game Server .. */
...
public void OnPluginStart()
{
    ...
    int nRequiredArrayCells =   ByteCountToCells(PLATFORM_MAX_PATH);

    g_hConVarsNames =           CreateArray(nRequiredArrayCells);
    g_hConVarsValues =          CreateArray(nRequiredArrayCells);
